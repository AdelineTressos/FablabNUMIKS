...
class PublicationsRepository extends ServiceEntityRepository
{
    ...
    // Dans src/Repository/PublicationsRepository.php

    public function findAllPublishedOrderedByDateDesc()
    {
        return $this->createQueryBuilder('p')
            ->where('p.is_published = true') // Assurez-vous que cette condition existe et est correcte
